...
$qery = "SELECT tblstudents.StudentName,tblstudents.logo,tblstudents.Departments,tblstudents.RollId,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status,tblclasses.ClassName,tblclasses.Section from tblstudents 
join tblclasses on tblclasses.id=tblstudents.ClassId where tblstudents.RollId=:rollid and tblstudents.ClassId=:classid ";
                        ...
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <div class="panel print_p">
                                    ...
                                    $_SESSION['rollid']=$rollid;
                                    $_SESSION['classid']=$classid;
                                    $qery = "SELECT   tblstudents.StudentName,tblstudents.Gender,tblstudents.DOB,tblstudents.Departments,tblstudents.RollId,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status,tblclasses.ClassName,
                                    ...
                                    {   ?>
                                            ...
                                            <div class="secondtable" style="float: right;width: 64%;">
                                                ...
                                                $t = $_POST["term"];
                                                $y = $_POST["year"];
                                                $stmt = $dbh->query("SELECT * FROM tblresult WHERE StudentId = '$moreid' and term = '$t' and year = '$y'");
                                     ...
                                     ?>
                                        ...
                                        <div class="panel-body p-20">
                                            <table class="table table-hover table-bordered" style="text-align: center;">
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Cont. Assess.</th>
                                                        <th>Exam Score</th>
                                                        <th><?php echo $_POST["term"];?> Score</th>
                                                        <th>Grade</th>
                                            ...
                                            $query->bindParam(':term',$_POST["term"],PDO::PARAM_STR); //I stoped here

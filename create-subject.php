...
$sql="INSERT INTO  tblsubjects(SubjectName,SubjectCode) VALUES(:subjectname, :code)";
$query = $dbh->prepare($sql);
$query->bindParam(':subjectname',$subjectname,PDO::PARAM_STR);
$query->bindParam(':code',substr(rand(0,time()), 0,5),PDO::PARAM_STR);
$query->execute();
                                ...
                                <form class="form-horizontal" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            ...
                                            <a href="manage-subjects.php" class="btn btn-primary"

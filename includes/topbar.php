            	...
            	<div class="container-fluid">
                    <div class="row">
                        <div class="navbar-header no-padding">
                            ...
                            $rowww = $stmt->fetch(PDO::FETCH_OBJ);
                            ?>
                            <img src="images/<?php echo htmlentities($rowww->logo); ?>" style="float: left;height: 19px;margin-right: 6px;">
                            <?php
                            echo htmlentities($rowww->title);
                            ?>
                			</a>

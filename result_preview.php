...
{   ?>
                    <div class="printindis" style="width: 100%;">
                        <img src="images/background/<?php echo htmlentities($rowprint->logo); ?>"
                        ...
                        <div style="float: right;margin-right: 16%;text-align: center;">
                            <div style="float: left;">
                                ...
                                <p
                                    style="text-transform: uppercase;font-weight: bold;background: black;color: white;padding: 5px;margin-bottom: 1px;">
                                    <b style="margin-left: 31px;text-align: left;">Motto:</b> <span
                                        style="margin-left:37px; text-align: center;"><?php echo htmlentities($rowprint->description); ?></span>
                                </p>
                    ...
                    <div class="printing" style="width: 100%;margin-left: auto;margin-right: auto;">
                        ...
                        <div style="margin-left: 75px;text-align: center;">
                            ...
                            <div style="float: left;">
                                <img src="images/<?php echo htmlentities($row->logo); ?>" style="height: 83px;">
                            </div>
                                ...
                                <div class="panel">
                                    ...
                                    {   ?>
                                            ...
                                            <div class="secondtable" style="float: right;width: 64%;">
                                                ...
                                                $stmt = $dbh->query("SELECT * FROM tblresult WHERE StudentId = '$moreid'");

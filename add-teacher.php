...
{
     $email = $_POST["email"];
    $query = mysqli_query($con, "SELECT * FROM teacher WHERE email='$email' ") or die();
    if ($rowe = mysqli_fetch_assoc($query)) {
        $error = "Teacher already registered" or die();
    }else{
        ...
        //SQL query start
            $sql="INSERT INTO  teacher(fullName,email,mobileNo,password,classid) VALUES(:fullName,:email,:mobileNo,:password,:classid)";
                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" method="post" action="">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="fullName" class="form-control" id="fullanme"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="email" name="email" class="form-control" id="fullanme"
                                                required="required" autocomplete="off"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="password" class="form-control" id="fullanme"
                                                required="required" autocomplete="off"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="cpassword" class="form-control" id="fullanme"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="mobileNo" placeholder="Enter your number"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">

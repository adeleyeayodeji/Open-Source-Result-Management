...
if (!isset($_GET['studentid']) || !isset($_GET['term']) || !isset($_GET['year']) ||
empty($_GET['studentid'])) {
 echo "<script>alert('Invalid access! Please provide required parameters.');
...
// Check if settings were fetched successfully
if (!$rowfrontt) {
...
10px;">
 ...
 <?php
 // Prepare statement to securely fetch student details
...
window.location.href='index.php';</script>";
 ...
 ?>
 <form action="viewresult_admin.php" method="post">
 <!-- Display Student ID -->
...
?>
 ...
 <!-- Hidden Inputs for Term and Year -->
 <input type="hidden" name="term" value="<?php echo
htmlentities($term); ?>">

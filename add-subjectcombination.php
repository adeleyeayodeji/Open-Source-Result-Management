...
{
//Using array query for the subjects selections
    $status = 1;
    $class = $_POST["class"];
  foreach ($_POST['subject'] as $value)
         {
            //Inserting my query with foreach
            $query = mysqli_query($con, "INSERT INTO tblsubjectcombination(ClassId, SubjectId, status) VALUES('$class', '$value', '$status') ");
         } 
...
<div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
 <select name="subject[]" multiple class="form-control" id="default" required="required" style="height:500px;">

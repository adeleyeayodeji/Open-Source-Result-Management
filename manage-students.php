                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    ...
                                    if (isset($_SESSION["teacher"])) {
                                        ...
                                        $qrq = mysqli_query($con, "SELECT * FROM tblclasses WHERE id = '$tiid' ") or die();
                                        $qrqr = mysqli_fetch_assoc($qrq);
                                        echo strtolower($qrqr["ClassName"]);
                                    }
                                     ?> Students</li>
            						</ul>
                                </div>
                                                ...
                                                <div id="printableArea">
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Action</th>
                                                            <?php
                                                            echo (isset($_SESSION["teacher"]))? '':'<th>Delete</th>';
                                                            ?>
                                                        </tr>
                                                    </thead>
                                                    <tfoot>
...
if (isset($_SESSION["teacher"])) {
    ...
    $sql = "SELECT tblstudents.StudentName,tblstudents.session,tblstudents.logo,tblstudents.RollId,tblstudents.Departments,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status,tblclasses.ClassName,tblclasses.Section from tblstudents join tblclasses on tblclasses.id=tblstudents.ClassId ORDER BY tblstudents.StudentId DESC";
}
